  ...
  return (
    <>
      ...
      <div className="flex min-h-screen">
        {/* ── LEFT: visual panel ── */}
        <div ref={leftRef} className="relative hidden overflow-hidden bg-[#120a06] lg:flex lg:w-[52%]">
          {/* Ambient orbs */}
          {[
            { cls: "orb absolute h-96 w-96 rounded-full blur-[80px] bg-[#b65b3a]/20", style: { top: "-10%", left: "-10%" } },
            { cls: "orb absolute h-72 w-72 rounded-full blur-[60px] bg-[#9e4e31]/15", style: { bottom: "5%", right: "-5%" } },
            { cls: "orb absolute h-48 w-48 rounded-full blur-[50px] bg-[#c47d50]/10", style: { top: "45%", left: "40%" } },
