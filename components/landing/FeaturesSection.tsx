...
export default function FeaturesSection() {
  ...
  return (
    <section id="features" className="relative bg-[#FFF9F2] px-5 py-24 text-[#231A15] sm:px-8">
      <svg
        ...
        aria-hidden
      >
        <path d="M0,80 C360,0 1080,80 1440,0 L1440,80 Z" fill="#FFF9F2" />
      </svg>

      <div className="mx-auto grid max-w-7xl grid-cols-12 gap-10">
        <aside className="col-span-12 lg:col-span-5">
          <div className="lg:sticky lg:top-[100px]">
            <p className="font-mono text-[11px] tracking-[0.2em] text-[#B65B3A]">WHY BOOKING_SYSTEM</p>

            <h2 className="mt-4 max-w-[540px] font-display text-[clamp(42px,4.6vw,52px)] font-bold leading-[1.05] text-[#231A15]">
              Built for people
              <br />
              who love live
              <br />
            ...
            <p className="mt-5 max-w-[340px] text-[17px] leading-[1.7] text-[#6D5A4E]">
            ...
            <motion.button
              ...
              className="group mt-8 inline-flex items-center gap-2 text-[15px] font-semibold text-[#B65B3A]"
              whileHover="hovered"
            >
          ...
          {features.map((feature, index) => {
            ...
            return (
              <motion.article
                ...
                className="rounded-[20px] border border-[#E9DDCF] bg-[#FFFCF7] p-8 transition-[box-shadow] duration-[250ms] hover:shadow-[8px_8px_20px_#E2D4C4,-8px_-8px_20px_#FFFFFF]"
              >
                <div className="flex items-start gap-5">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[rgba(182,91,58,0.1)] text-[#B65B3A]">
                    <Icon className="h-7 w-7" />
                  </div>

                  <div>
                    <h3 className="text-xl font-semibold text-[#231A15]">{feature.title}</h3>
                    <p className="mt-3 text-[15px] leading-[1.7] text-[#6D5A4E]">{feature.description}</p>
                  </div>
                </div>
              </motion.article>
            );
